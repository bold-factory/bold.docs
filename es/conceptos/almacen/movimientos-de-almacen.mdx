...
sidebarTitle: "Movimientos de almacén"
...
Un **movimiento de almacén** es una tarea para recoger material en una o varias ubicaciones y dejarlo en un destino.

No es lo mismo que un [movimiento de stock](/es/conceptos/almacen/stock-y-movimientos). El movimiento de almacén dirige el trabajo físico. Los movimientos de stock son los registros que auditan cada recogida y entrega.
...
| **Cancelado** | Se anuló con un motivo y se liberaron sus reservas. Si estaba en curso, también se cierra su ejecución. |
...
stateDiagram-v2
  ...
  En_curso --> Cancelado: sin material en el equipo
```

Un movimiento no puede completarse ni cancelarse mientras el equipo todavía transporte stock o bultos. Puedes cancelar un movimiento pendiente, preparado o en curso cuando no queda material transportado; la interfaz solicita un motivo de cancelación.
