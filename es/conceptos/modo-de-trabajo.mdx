...
En producción, el modo de trabajo puede organizar las tareas según el empleado activo y su contexto operativo.

| Criterio | Cómo afecta a la lista de trabajo |
| --- | --- |
| Habilidades | Muestra procesos o tipos de operación que el empleado puede ejecutar. |
| Estaciones habituales | Prioriza operaciones de sus estaciones normales. |
| Operaciones asignadas | Enseña trabajo preparado para esa persona. |
| Grupos de operaciones | Permite continuar bloques de trabajo compartidos. |
| Operaciones activas o recientes | Facilita reanudar trabajo iniciado o pausado. |

Las [habilidades y estaciones habituales](/es/conceptos/personal/habilidades-y-estaciones-habituales) no sustituyen una asignación real. Ayudan a reducir ruido y a presentar primero el trabajo más probable.
