...
Usa una familia común. Por ejemplo, **Mesa Nórdica**. Mantén el caso corto para que el equipo vea el recorrido antes de añadir variantes, controles, turnos, costes o reglas avanzadas.

## Flujo operativo general

<Steps>
  <Step title="Crea el catálogo">
    Define familias y artículos. Añade propiedades si necesitas variantes como color, medida, material o acabado.
  </Step>
...
<Steps>
  <Step title="Crea el catálogo mínimo">
    Crea la familia, el artículo terminado y los componentes que quieras consumir durante la fabricación. Marca el artículo terminado como fabricable.
  </Step>
