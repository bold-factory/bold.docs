...
Primeros pasos te guía por el recorrido mínimo para ver valor en Bold: preparar los datos base, definir cómo se fabrica un producto común, crear un pedido, convertirlo en una orden de fabricación y registrar su ejecución.
...
Cuando la OF genere stock del artículo terminado, puedes preparar y registrar el envío del pedido. Hazlo si quieres validar también la salida de stock, pero no es necesario para entender el valor principal del flujo.
