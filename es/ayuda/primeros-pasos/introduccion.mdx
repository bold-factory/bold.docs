...
Esta sección recorre el flujo mínimo para empezar a usar Bold: preparar los datos base, definir cómo se fabrica un producto habitual, crear un pedido, convertirlo en una orden de fabricación y registrar su ejecución.
...
<Steps>
  ...
  <Step title="Ejecuta en planta">
    Entra en el **modo de trabajo**, selecciona el empleado, inicia la operación, registra el avance y los consumos, y finaliza la OF.
  </Step>
</Steps>
...
| Personal | El empleado aparece en el **modo de trabajo** y queda asociado al registro operativo. |
...
| Perfiles detallados | Cuando sepas qué acciones necesita realizar cada función. |
