...
<Info>
  La referencia completa se genera desde OpenAPI. Puedes consultarla en la sección **Referencia de API** o abrirla en `https://api.bold-factory.com/docs/v1`.
</Info>
...
<Card title="Abrir referencia externa" icon="external-link" href="https://api.bold-factory.com/docs/v1">
