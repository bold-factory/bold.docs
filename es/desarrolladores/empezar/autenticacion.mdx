---
title: "Autenticación"
description: "Autentica llamadas a la API de Bold con claves API o credenciales de sesión."
---
...
La creación, consulta y desactivación de claves se hace desde **Panel de control \> Acceso \> Claves API**. Consulta [Claves de integración y avisos externos](/es/conceptos/panel-de-control/claves-de-integracion-y-avisos-externos) para entender cómo se administran las claves y los avisos externos.
