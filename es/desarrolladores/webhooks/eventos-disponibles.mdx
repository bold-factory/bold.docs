...
<Info>
  Usa siempre el listado del entorno donde vas a integrar. Los eventos disponibles pueden crecer con nuevas funcionalidades. Estos endpoints requieren acceso a la aplicación.
</Info>
...
| `Maintenance.WorkOrder.Completed` | Enviar cierre de mantenimiento a BI o ERP. |
