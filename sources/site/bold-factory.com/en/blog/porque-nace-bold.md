# Source: https://bold-factory.com/en/blog/porque-nace-bold
...
![Post cover image](https://bold-factory.com/_next/image?url=%2Fimages%2Fporque-nace.jpg&w=2048&q=75)

Share on:

_Industria 4.0, IoT, gemelo digital, blockchain…_ En los últimos diez años ha habido un bombardeo constante de estos términos, y pareciera que la industria española ha dado un triple salto en cuanto a digitalización, pero si uno se acerca a ver la realidad de la PYME industrial, podrá apreciar que el **Excel y el papel siguen estando a la orden del día**.
...
Pero llegaron los 2000 y empiezan a aparecer lo que conocemos como MES (_Manufacturing Execution System_). Estos sí ponen la fabricación en el centro, pero nacen como una capa de comunicación entre un ERP y un sistema SCADA o similar: son algo accesorio, y que además ignora el resto de departamentos.
